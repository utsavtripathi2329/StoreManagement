...
inventory = pd.read_excel('C:/Users/RM119WK/Documents/Untitled Folder/Inventory.xlsx')

sale = pd.read_excel('C:/Users/RM119WK/Documents/Untitled Folder/Sales.xlsx')
...
inventory.to_excel('C:/Users/RM119WK/Documents/Untitled Folder/Inventory.xlsx', index=False)

st.sidebar.write('Inventory')
st.sidebar.dataframe(inventory.loc[:,'Item':'Price'])

sale.to_excel('C:/Users/RM119WK/Documents/Untitled Folder/Sales.xlsx', index=False)

st.subheader(f'Sale Summary for {dateStr}:')

sale_summary = pd.read_excel('C:/Users/RM119WK/Documents/Untitled Folder/Sales.xlsx')
